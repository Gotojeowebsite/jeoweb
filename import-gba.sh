...
#  GBA GAME IMPORTER
#
#  Takes a Game Boy Advance ROM file and creates a fully
#  self-contained game folder under Assets/ with an HTML-based
#  GBA emulator (EmulatorJS + mgba core).
#
#  Usage:
#    ./import-gba.sh <rom-file> [game-name]
#
#  Examples:
#    ./import-gba.sh ~/roms/PokemonEmerald.gba
#    ./import-gba.sh ~/roms/PokemonEmerald.gba pokemon-emerald
#    ./import-gba.sh ~/roms/Zelda.gba zelda-minish-cap
#
#  Supported ROM extensions: .gba, .gb, .gbc, .zip, .7z
#
#  The generated folder will contain:
#    - index.html  (EmulatorJS-powered GBA emulator page)
#    - The ROM file
# ============================================================
set -euo pipefail
...
if [ $# -lt 1 ]; then
    ...
    echo ""
    echo "Examples:"
    echo "  $0 ~/roms/PokemonEmerald.gba"
    echo "  $0 ~/roms/PokemonEmerald.gba pokemon-emerald"
    exit 1
fi
...
for QUERY_SUFFIX in "gba game logo" "gameboy advance game thumbnail" "gba game" "game"; do
...
echo ""
echo "=== GBA game imported successfully! ==="
