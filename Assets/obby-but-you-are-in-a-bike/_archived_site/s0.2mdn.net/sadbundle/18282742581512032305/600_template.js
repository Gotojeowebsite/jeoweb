...
function buildCommunities(data) {
  ...
  document.querySelector(".comunTxt span").innerHTML = dynamicContent.pulte_dma_marketwide_Main[0].CTAName + ' ' + ">";
  document.querySelector('.priceK').innerHTML = '$' + dynamicContent.pulte_dma_marketwide_Main[0].RegionPriceLow  + ' to ' + '$' + dynamicContent.pulte_dma_marketwide_Main[0].RegionPriceHigh;
  communityImage.style.backgroundImage = "url('" + dynamicContent.pulte_dma_marketwide_Main[0].RegionImage.Url + "')";
...
function startAd(){
  ...
  buildCommunities(devDynamicContent.pulte_dma_marketwide_Main[0]);
...
function clickIt(e){
  ...
  Enabler.exitOverride("bgExit", dynamicContent.pulte_dma_marketwide_Main[0].RegionURL.Url);
}
