...
function runAnimation(){
 ...
 TweenLite.to(bg1, 1, {delay:2.5, x:-728, ease:Linear.easeNone});
 TweenLite.to(txt1, 1, {x:-728, delay:2.5, ease:Linear.easeNone});
 TweenLite.to(logo, 1, {delay:2.5, x:-728,ease:Linear.easeNone});
