  ...
  if (nav) {
    ...
    const html = `
      <div id="icon-container">
        <a class="icon" href="index.html"><img alt="nav" id="INImg" src="${LogoUrl}"/></a>
      </div>
      <div class="f-nav-right">
        <a class="navbar-link" href="../../../index.html"><i class="fa-solid fa-arrow-left navbar-icon"></i><an>&#66;&#97;&#99;</an><an>&#107;</an></a>
        ...
        ${qp ? "" : '<a class="navbar-link" href="tabs.html"><i class="fa-solid fa-laptop navbar-icon"></i><an>&#84;&#97;</an><an>&#98;&#115;</an></a>'}
