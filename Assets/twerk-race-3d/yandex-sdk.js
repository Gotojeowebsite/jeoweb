...
(() => {
  ...
  var e = {
      ...
      393: (e, t, n) => {
        ...
        var m,
          g =
            (((m = g || {}).Click = `click${r.ej}`),
            (m.Dblclick = `dblclick${r.ej}`),
            (m.Mouseup = `mouseup${r.ej}`),
            (m.Pointerup = `pointerup${r.ej}`),
            (m.Touchend = `touchend${r.ej}`),
            m);
        const y = {
            ClickOnBody: () => ({
              type: p,
      ...
      719: (e, t, n) => {
        ...
        var u,
          h = (((u = h || {}).Start = `${d}_start`), (u.Stop = `${d}_stop`), u);
        const p = "-on-body",
          m = "screen_recorder";
        var g,
          y = (((g = y || {}).Start = `${m}_start`), (g.Stop = `${m}_stop`), g);
        const f = "debug-panel";
        var v = ((e) => ((e.i18n = "i18n"), e))(v || {});
        const w = "sdk-event";
        var b = ((e) => (
          (e.BONUS_AWARDED = "BONUS_AWARDED"),
          (e.EXIT = "EXIT"),
      ...
      754: (e, t, n) => {
        ...
        function s(e, t, n) {
          "YaGames" in window ||
            console.warn(
              "Don't use logSDKError or logSDKGameError outside SDK"
            );
          const r = (0, a.U)(e, t, n);
          r &&
            o.F.postToParent({
      ...
      998: (e, t, n) => {
        ...
        var r = n(399),
          ...
          u = (e, t) => {
            ...
            if (i) for (var n of i(t)) l.call(t, n) && d(e, n, t[n]);
            return e;
          },
          h = (e, t) => o(e, s(t));
        ...
        function m(e, t, n) {
          ...
          const i = (function (e, t) {
            ...
            return (
              (s.additional = h(u(u({}, e.additional), t.additional), {
                version: parseInt(
          ...
          return (
            ...
            p.some((e) => e.test(c))
              ? null
              : (n.message && (i.message = n.message),
                n.prefix && (i.message = `${n.prefix} ${i.message}`),
                {
                  ...
                  source: e,
                  sourceMethod:
                    null != (o = n.sourceMethod) ? o : (0, r.Z)(i.stack),
      ...
      498: (e, t, n) => {
        ...
        function a() {
          ...
          const n =
            (null ==
            (t =
              null == (e = window.YandexGamesSDKEnvironment) ? void 0 : e.app)
              ? void 0
              : t.id) || "";
          return (
            n || (0, r.f)(new Error("Can not get appId from environment")), n
          );
        }
      },
      280: (e, t, n) => {
        ...
        const c = {
          ...
          params(e) {
            s.F.hasParent() &&
              s.F.postToParent(r.sF.Params(e)).catch((e) => {
                (0, a.f)(e);
              });
          },
          reachGoal(e, t, n) {
      ...
      89: (e, t, n) => {
        ...
        class o {
          ...
          createErrorInstance(e, t) {
            if (t)
              try {
                const { message: e, code: n, httpStatus: o } = JSON.parse(t);
          ...
          checkExternalEvent(e) {
            var t;
            return (
              "YandexGamesSDK" === (null == (t = e.data) ? void 0 : t.source)
            );
          }
          _offMessage(e, t, n) {
          ...
          _post(e, t) {
            ...
            if ("timeout" in t) {
              const { timeout: e } = t;
              "number" == typeof e && e > 0
                ? (this.promises[r].timeoutId = window.setTimeout(() => {
                    this.deletePromise(r);
  ...
  (() => {
    ...
    const t = (e) => {
      ...
      if (
        ...
        r && l.setAttribute("crossOrigin", r),
        a &&
          (l.setAttribute("id", `${a}-script`),
          (l.dataset.rcid = `load-script-${a}`)),
        n)
      ) {
    ...
    function s(e, t) {
      ...
      return function (...a) {
        const o = a,
          s = this;
        return (
          n || ((n = !0), setTimeout(() => (n = !1), t), (r = e.apply(s, o))), r
        );
      };
    }
    var i = n(393),
    ...
    function h(e, t = "Dev", n) {
      if (!new URLSearchParams(location.search).get("debug-mode"))
        return () => {};
    ...
    var v = (e, t, n) =>
      new Promise((r, a) => {
        var o = (e) => {
          ...
          i = (e) =>
            e.done ? r(e.value) : Promise.resolve(e.value).then(o, s);
    ...
    const w = {
      ...
      b = class {
        constructor() {
          (this.log = h("Achievements | Child frame", "Dev", w)),
            (this.observable = new f(this.log)),
            ...
            (this.post = (e) =>
              v(this, null, function* () {
                ...
                return l.F.postToParent(e)
                  .then((t) => {
                    var n;
                    this.log("receive from parent", e, t);
                    const { result: r, success: a, error: o } = t.data;
                    return a && r
                      ? (this.notify(
                          e.action,
                          null != (n = e.data) ? n : {},
        ...
        (function () {
          ...
          Object.defineProperty(window, "Ya", {
            get() {
              var e;
              return (
                (null == (e = null == a ? void 0 : a.Context)
                  ? void 0
                  : e.AdvManager) &&
                  a.Context.AdvManager !== r &&
                  (a.Context.AdvManager = r),
                A(),
                a
              );
            ...
            S("disable Ya.Context.AdvManager.render");
        })());
    }
    ...
    class C {
      constructor(e) {
        ...
        (this.callbacks = {}),
            ...
            switch ((x(`onAdvManagerExternalMessage ${f}`), f)) {
              ...
              case "adv-callback-error":
                ...
                try {
                  if (
                    "string" !=
                    typeof (null == (r = null == v ? void 0 : v.error)
                      ? void 0
                      : r.message)
                  ) {
                ...
                null == (o = (a = this.callbacks).onError) ||
                  o.call(
                    a,
              ...
              case "rewarded-video-callback-error":
                null == (y = (g = this.callbacks).onError) ||
                  y.call(
                    g,
                    new Error(v.error.message, {
                      cause: v.error,
              ...
              case "set-disabled-state":
                x('On "set-disabled-state" event', e.data, v.value),
                  this.setDisabledState(v.value);
            }
          }),
          (this.adv = e.adv || {}),
          ...
          l.F.onExternalMessage(
            "adv-manager",
            this.onAdvManagerExternalMessage
          ),
          l.F.onExternalMessage(
            "adv-debug-manager",
      ...
      updateDisabledState() {
        l.F.postToParent(i.X$.GetDisabledState())
          .then(({ data: e }) => {
      ...
      showFullscreenAdv({ callbacks: e = {} } = {}) {
        ...
        l.F.postToParent(i.X$.AdvShowFullscreen())
          .then(({ data: { error: t } }) => {
            if (!t)
      ...
      showRewardedVideo({ callbacks: e = {} } = {}) {
        ...
        l.F.postToParent(i.X$.AdvShowRewardedVideo())
          .then(({ data: { error: t } }) => {
            if (t) throw t;
            this.setCallbacks(e, [
              "onOpen",
      ...
      showBannerAdv() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.X$.AdvShowStickyBanner())
            .then(({ data: t }) => {
              e(t);
            })
            .catch((t) => {
      ...
      hideBannerAdv() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.X$.AdvHideStickyBanner())
            .then(({ data: t }) => {
              e(t);
            })
            .catch((t) => {
      ...
      getBannerAdvStatus() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.X$.AdvStatusStickyBanner())
            .then(({ data: t }) => {
              e(t);
            })
            .catch((t) => {
    ...
    class j {
      ...
      getPayingStatus() {
        return (
          l.F.postToParent(i.yH.GetGamePurchaseEnabled()).then(
            ({ data: { enabled: e } }) => {
              e ||
                (0, m.T)(
                  new Error(
              ...
              const r =
                ...
                a =
                  (null == (n = window.YandexGamesSDKEnvironment)
                    ? void 0
                    : n.i18n.tld) || "ru";
              return "https://games-sdk.%DOMAIN_NAME%.%TLD%/games/api/sdk/v1"
                .replace(F.O6, r)
                .replace(F.U0, a);
            })()}/player/avatar/${this._personalInfo.avatarIdHash}/${t}`
          : `https://avatars.mds.yandex.net/get-yapic/${F._h}/${t}`;
      }
    }
    var M = Object.defineProperty,
      ...
      H = (e, t) => {
        ...
        if (U) for (var n of U(t)) Y.call(t, n) && V(e, n, t[n]);
        return e;
      };
    const K = (e, t) => {
        l.F.postToParent(
      ...
      q = () => (
        ...
        new Promise((e, t) => {
          function n(r) {
            ...
            const o =
              (null == (a = r.data.data.playdeck.value) ? void 0 : a.data) ||
              "{}";
            if ("string" == typeof o)
              try {
                e(JSON.parse(o));
          ...
          l.F.onExternalMessage("telegram", n),
            setTimeout(() => {
    ...
    var X = Object.defineProperty,
      ...
      te = (e, t, n) =>
        t in e
          ...
          : (e[t] = n);
    const ne = s(
      (e) => l.F.postToParent(i.S.Score(e)).then(({ data: e }) => e.result),
      1e3
    );
    class re {
      ...
      getLeaderboardEntries(e, t) {
        const {
          ...
          o = y("Leaderboards.getLeaderboardEntries"),
          s = l.F.postToParent(
            i.S.Entries({
              include_user: n,
              name: e,
            ...
            const { avatarPrefix: t, result: n } = e,
              { entries: r, leaderboard: a, ranges: o, userRank: s } = n;
            return {
      ...
      getLeaderboardPlayerEntry(e) {
        return (
          ...
          (n = null),
          (r = function* () {
            const { data: t } = yield l.F.postToParent(
              i.S.PlayerEntry({
                name: e,
              })
            );
          ...
          new Promise((e, a) => {
            var o = (e) => {
              ...
              i = (t) =>
                t.done ? e(t.value) : Promise.resolve(t.value).then(o, s);
    ...
    class ie extends Error {
      constructor({ code: e, httpStatus: t, message: n }, r, a) {
        super(n, r, a),
    ...
    class Te {
      ...
      ___test1212() {
        ...
        a.setAttribute("id", "payElement1212-noads"),
          a.setAttribute("style", `${r} top: 5px;`),
          (a.textContent = 'purchase("noads")'),
          (a.onclick = () => this.___test1212Purchase("noads")),
          document.body.appendChild(a),
          (a = document.createElement("div")),
          a.setAttribute("id", "payElement1212-3x3antiblock"),
          a.setAttribute("style", `${r} top: 40px;`),
          (a.textContent = 'purchase("3x3antiblock")'),
          (a.onclick = () => this.___test1212Purchase("3x3antiblock")),
          document.body.appendChild(a);
      }
    ...
    let De = () => (
      ...
      (De = () => window.YandexGamesSDKEnvironment || Ie),
      De()
    );
    const xe = {
      get app() {
    ...
    function Ge(e) {
      const { data: t, signature: n } = (function (e, t) {
        if ("signature" in e) {
          const { signature: n } = e;
          if ("string" == typeof n) {
            const { data: e } = JSON.parse(oe(n.split(".")[1]));
            return {
              data: e,
              signature: n,
            };
        ...
        super(e),
          ...
          (this.getPlayerData = () => {
            return (
              ...
              (t = null),
              (n = function* () {
                const { data: e } = yield l.F.postToParent(
                  i.Uh.GetData({
          ...
          (this.getDataPromise = () =>
            void 0 !== this.data
              ...
              : xe.isTelegram
              ? q().catch(() => this.getPlayerData())
              : this.getApiPromise()),
          (this.config = t),
          (Ue && Ue.isSamePlayer(this.getUniqueID())) ||
            (Ue = new Re(this.getUniqueID()));
      }
      onLogout(e) {
      ...
      static load() {
        ...
        return t
          ? ((e.onloadPromise_ = Promise.race([
              ...
              l.F.postToParent(i.Qq.GetAll()).then(({ data: e }) => {
                for (let [n, r] of Object.entries(e)) t.setItem(n, String(r));
                return t;
              }),
            ]).catch((e) => (console.error(e), Ke))),
            e.onloadPromise_)
          : Promise.resolve(Ke);
      }
        ...
        return new Proxy(
          {
            ...
            setItem(e, t) {
              Ke.setItem.call(Ke, e, String(t)),
                l.F.postToParent(i.Qq.Set(e, t));
            },
          },
          {
            get: function (e, t) {
    ...
    var nt = Object.defineProperty,
      ...
      it = (e, t) => {
        ...
        if (rt) for (var n of rt(t)) ot.call(t, n) && st(e, n, t[n]);
        return e;
      };
    const ct = (e) => ({
      get id() {
      ...
      get imageURI() {
        const { image: t } = e;
        return t && "object" == typeof t && "url_prefix" in t
    ...
    var lt = Object.defineProperty,
      ...
      yt = (e, t) => {
        ...
        if (ht) for (var n of ht(t)) mt.call(t, n) && gt(e, n, t[n]);
        return e;
      },
      ft = (e, t) => dt(e, ut(t)),
      vt = (e, t, n) =>
        ...
        constructor(e) {
          (this.getCatalog = () =>
            vt(this, null, function* () {
              var e;
              const { data: t } = yield l.F.postToParent(i.Aw.Catalog(wt()));
              return (
                null != (e = null == t ? void 0 : t.bonuses) ? e : []
              ).map(ct);
            })),
    ...
    bt.init = (e) => {
      const { getCatalog: t, getPlayerBonuses: n, consume: r } = new bt(e),
        a = {
          getCatalog: t,
          getPlayerBonuses: n,
          consume: r,
    ...
    const _t = (function ({ matchers: e, updateErrorTitle: t = xt }) {
        return function (n) {
          for (const r of e)
            if (
              (r.regexp && -1 !== n.search(r.regexp)) ||
              (r.substr && n.includes(r.substr))
            )
              return {
    ...
    var Lt = Object.defineProperty,
      ...
      $t = (e, t) => {
        ...
        if (Rt) for (var n of Rt(t)) Nt.call(t, n) && Gt(e, n, t[n]);
        return e;
      };

    function jt(e, t) {
      t && (e.type = t),
        l.F.postToParent((0, i._X)(e)).catch((e) => {
          console.warn(e);
        });
    }
        ...
        n.stack && n.message
          ...
          : ((r = String(n)),
            "[object Event]" === r
              ...
              : "[object Object]" === r &&
                ((a.unhandledObject = n),
                (r = n.message || "Undefined error message"))),
          (null == (t = n.target) ? void 0 : t.src) && (a.src = n.target.src);
        const o = {
          additional: a,
          ...
          c = {
            columnNumber:
              ...
              (r =
                ...
                ? r
                : -1,
            fileName: this._trimErrorData(
              e.filename || (null == i ? void 0 : i.fileName) || "",
              200
            ),
            lineNumber:
              null !=
              (o =
                null != (a = e.lineno) ? a : null == i ? void 0 : i.lineNumber)
                ? o
                : -1,
            message: this._trimErrorData(
              e.message || (null == i ? void 0 : i.message) || "",
              200
            ),
            name: this._trimErrorData(
              (null == i ? void 0 : i.name) || "Error",
              200
            ),
            stack: this._trimErrorData(
              null != (s = null == i ? void 0 : i.stack) ? s : "",
              3e3
            ),
          };
        (this.additionalErrorData || (null == i ? void 0 : i.additional)) &&
          (c.additional = $t(
            $t({}, null == i ? void 0 : i.additional),
            this.additionalErrorData
          )),
          console.error(c.message, F.X4, c),
          this._postError(c, t);
      }
      _trimErrorData(e, t) {
      ...
      (function () {
        try {
          ...
          console.error = (...t) => {
            ...
            n || (n = Ct(t));
            try {
              "string" == typeof t[1] && t[1] === F.X4
                ? t.splice(1, 1)
                : jt(Mt(n), "console.error");
            } catch (e) {}
            e.apply(console, t);
          };
        } catch (e) {
    ...
    const Bt = h("Events bus", "Dev", {
      ...
      qt = (e, t) => {
        ...
        Bt(`[off]: {${e}}`),
          Yt.unsubscribe(e, t),
          null == (n = Kt[e]) || n.call(Kt, e);
      },
      Xt = (e, t) => {
        Bt(`[notifyObservers]: {${e}}`, ...(t ? [t] : [])),
          Yt.notifyObservers(Array.isArray(e) ? e : [e], t);
      };
    l.F.onExternalMessage(Vt, ({ data: { action: e, data: t } }) => Xt(e, t));
    ...
    const en =
      ...
      tn = () => {
        Zt ||
          (l.F.postToParent((0, i.Iq)(Array.from(Qt).join(","))),
          Qt.clear(),
          (Zt = !0));
      };
    var nn;
    ...
    let on = class e {
      ...
      getAllGames() {
        ...
        const t = y("getAllGames"),
          n = new Promise((e, n) =>
            l.F.postToParent(i.Rh.All())
              .then(({ data: t }) => {
                var n;
                (null == (n = window.YandexGamesSDKEnvironment)
                  ? void 0
                  : n.useMockGameLinks) &&
                  (t.games.forEach((e) => (e.url = `${rn}`)),
                  (t.developerURL = `${rn}`)),
                  e(t);
              })
              .catch((e) => {
    ...
    const sn = on.instance,
      cn = class e {
        ...
        ready() {
          ...
          this.logGameInitTime(e, c.ur.GameReady),
    ...
    class hn {
      constructor(e = {}) {
        this[dn] = sn;
        for (let t in c.VR)
          c.VR[t] in e && e[c.VR[t]] && (this[t] = new un[t]());
        for (let t of c.Hn)
          !this[t] &&
            ((t in e && e[t]) || !(t in e)) &&
            (this[t] = new un[t]());
    ...
    c.VR.GameplayAPI,
      c.VR.LoadingAPI,
      c.VR.PluginEngineDataReporterAPI,
      (dn = c.VR.GamesAPI);
    var pn = ((e) => (
    ...
    const mn = new (class {
      canReview() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.E0.CanReview())
            .then(({ data: t }) => {
              e(t);
            })
            .catch((t) => {
      ...
      requestReview() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.E0.RequestReview())
            .then(({ data: t }) => {
      ...
      return (
        ...
        "object" == typeof (a = t) &&
          Object.keys(a).forEach((e) => {
            "signed" !== e &&
              (0, m.f)(
                new Error(`Using deprecated key in YaGames.init options: ${e}`)
              );
          }),
        (function (e = {}) {
          return (
            (function (e) {
              "adv" in e &&
                N.sendOnceDeprecatedUsage("SDK init options with adv");
              (e.adv = e.adv || {}),
                (function (e) {
    ...
    l.F.onExternalMessage("auth", (e) => {
      ["auth-dialog-cancel", "auth-dialog-success", "changed"].includes(
        e.data.action
      ) && (Tn("Clear getPlayer promises."), On.clear());
    });
    class Dn {
      constructor() {
        (this.onMessage = (e) => {
    ...
    const _n = Date.now(),
      ...
      Fn = (e) => {
        ...
        const s = document.createElement("div"),
          { activeClass: i = Cn, mainClass: c = Ln } = null != e ? e : {};
    ...
    function $n(e) {
      ...
      Cache.prototype[e] = function (e, n) {
        return "GET" !== e.method ||
          ...
          ((r = e.url), Gn.some((e) => -1 !== r.indexOf(e)))
          ? Promise.resolve()
    ...
    const Mn = new (class {
      canShowPrompt() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.lW.CanShowPrompt())
            .then(({ data: t }) => {
              e(t);
            })
            .catch((e) => {
      ...
      showPrompt() {
        return new Promise((e) => {
          ...
          l.F.postToParent(i.lW.ShowPrompt())
            .then(({ data: t }) => {
              e(t);
            })
            .catch((e) => {
    ...
    const qn = Kn(void 0, null, function* () {
      return (function ({ staticOrigin: n, version: r, logError: s }) {
              ...
              ? document.head.appendChild(
                  t({
                    ...
                    src: a(
                      n,
                      `stats-hash.js?v=${
                        r || new Date().setUTCHours(12, 0, 0, 0)
                      }`
                    ),
                    onErrCb: o,
                    onLoadCb: e,
      ...
      (() => {
        ...
        const { hash: e, hostname: t, search: n } = window.location;
        if (
        ...
        if (!r) return;
        let a;
        (a = /games\.s3\.yandex\.net$/.test(t)
          ? `https://yandex.ru/games/app/${r}${n}${e}`
          : `https://yandex.com/games/app/${r}${n}${e}`),
          window.top.location.replace(a);
      })(),
        gn(),
    ...
    class zn {
      constructor(e) {
        ...
        (e = Sn(e)),
            ...
            return new Promise((r, a) => {
              ...
              if (void 0 !== t)
                try {
                  ...
                  return (
                    console.warn(e),
                    void a(new Error('Wrong "detail" argument'))
                  );
                }
              l.F.postToParent((0, i.TI)(e, o))
                .then(() => {
                  r(!0);
                })
                .catch((e) => {
          ...
          (this.achievements = P.init()),
          (this.adv = en(new C(e), ["showBannerAdv"], "AdvManager")),
          (this.analytics = {
            yaMetrikaCounter: en(
              new Hn(),
              ["hit", "reachGoal", "sendGoal"],
              "YaMetrikaCounter"
            ),
          }),
          (this.auth = L),
          (this.bonuses = Pt.init(e.signed)),
          (this.clipboard = Tt),
          (this.deviceInfo = new Ot(e.deviceType)),
          (Zn.deviceInfo = this.deviceInfo),
          (this.environment = ((e) => {
            if (
              !new URLSearchParams(location.search).get("debug-mode") ||
              "function" != typeof Proxy
            )
              return e;
            ...
            return (
              Object.defineProperty(t, "i18n", {
                get() {
                  ...
                  return new Proxy(t, {
                    get: (e, t) => (
                      "lang" === t && l.F.postToParent(_e.i.I18n()), e[t]
                    ),
                  });
                },
              }),
          ...
          (this.shortcut = Mn),
          (this.getLeaderboards = ae),
          (this.getPayments = kn),
          (this.getPlayer = In),
          (this.getStorage = tt),
          (this.notifications = bn),
          (this.screen = new xn()),
          (this.features = en(
            new hn(e.features),
            [c.VR.GameplayAPI, c.VR.LoadingAPI],
            "FeatureManager"
          )),
          (this.yandexApp = {
            enabled: Boolean(
    ...
    class Zn {
      ...
      static init(e) {
        return Kn(this, null, function* () {
          ...
          return Xn
            ? (console.warn("YaGames was initialized"), Xn)
              ...
              (Xn = new Promise((n, r) => {
                      ...
                      e.environment.isTelegram &&
                        ...
                        (function () {
                          if (
                            ...
                            return;
                          const { startHighlighting: e, stopHighlighting: t } =
                            Fn();
                          l.F.onExternalMessage(
                            c.cV,
                            ({ data: { action: n } }) => {
                ...
                window.loadEnvironmentPromise
                  ...
                  setTimeout(() => {
                    ...
                    Wn("checkAndSendGameInfo tech data:", e),
                      Qn(() => {
                        l.F.postToParent((0, i.cp)(e));
                      });
                  }, 1e4);
              })),
              Xn.then(() => Wn("Initialized")),
              Xn);
        });
      }
    }
