...
! function(a) {
    var b = function() {
        function b() {}
        return b.loadPortalScript = function(b) { b && b.hasOwnProperty("minijuegos") && b.minijuegos.indexOf(a.Utils.getSourceSite()) !== -1 && (void 0 !== window.mpConfig ? window.mpConfig.partner = "orange-games" : window.mpConfig = { partner: "orange-games" }, addScript("../../../../../_external_mirror/ext.minijuegosgratis.com/external-host/main.js", Date.now() / 1e3)), b && b.hasOwnProperty("kongregate") && b.kongregate.indexOf(a.Utils.getSourceSite()) !== -1 && addScript("../../../../../_external_mirror/cdn1.kongregate.com/javascripts/kongregate_api.js", Date.now() / 1e3, function() { "undefined" != typeof kongregateAPI && kongregateAPI.loadAPI(function() { window.kongregate = kongregateAPI.getAPI() }) }), b && b.hasOwnProperty("newgrounds") && b.newgrounds.indexOf(a.Utils.getSourceSite()) !== -1 && addScript("../../../../../_external_mirror/cdn.fbrq.io/orange-games-splash/assets/scripts/newgroundsio.min.js", Date.now() / 1e3) }, b
    }();
    a.PortalScripts = b
}(Fabrique || (Fabrique = {}));
var Fabrique;
        ...
        var c = function(b) {
            ...
            return __extends(c, b), c.prototype.setup = function(b, c, d, e) {
                if (void 0 === e && (e = "auto"), ga("create", b, e), a.Utils.isOnDevice(this.game) && ga("set", "checkProtocolTask", null), void 0 !== c && ga("set", "appName", c), void 0 !== c && ga("set", "appVersion", d), ga("send", "pageview"), "auto" !== e) {
                    ...
                    ga("create", "G-DQM8XXB9GC", f)
                }
                else ga("create", "G-DQM8XXB9GC", e, "fbrq");
