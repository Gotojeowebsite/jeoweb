...
var preroll = {get config(){ var defaultValues = {
	...
	waitForClickMid: window['wgCustomImplementation'] === true ? false : true,
	...
	rewarded: {
		init: null,
		desktop: true,
		adTagURL: '/6062/sanghan_rweb_ad_unit',
		adTest:true
	},	
	...
	titleExtract:"-,2,left",
	gameThumbnail: ( typeof wgGameThumbnail !== "undefined" ? wgGameThumbnail : ( document.querySelectorAll('[property="og:image"]').length > 0  ? document.querySelectorAll('[property="og:image"]')[0].content : '../../st.wgplayer.com/afg_bkg.jpg' )),
	gameBackground: ( typeof wgGameBkgImage !== "undefined" ? wgGameBkgImage : ( document.querySelectorAll('[property="og:image"]').length > 0  ? document.querySelectorAll('[property="og:image"]')[0].content : '../../st.wgplayer.com/afg_bkg.jpg' )),
...
document.addEventListener('wgSdkReady', e => { 
	console.log( 'WeeGoo SDK is ready.' );
});
