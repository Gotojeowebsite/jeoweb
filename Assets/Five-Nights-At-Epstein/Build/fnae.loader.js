  ...
  var h,
    ...
    P = {
      ...
      IsConnectedToProfiler: function () {
        if (m.IsConnectedToProfiler)
          return m.IsConnectedToProfiler.apply(m, arguments);
        m.print(
          "Failed to execute IsConnectedToProfiler: Player not loaded yet.",
        );
      },
      Quit: function () {
